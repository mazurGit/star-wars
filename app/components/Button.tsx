...
import { activeOpacity, colors, spacing, typography } from "~app/theme";
...
const $leftAccessoryStyle: ViewStyle = { marginEnd: spacing.xSmall, zIndex: 1 };
...
const $pressedTextPresets: Record<Presets, StyleProp<TextStyle>> = {
  default: { opacity: activeOpacity.default },
  filled: { opacity: activeOpacity.default },
  reversed: { opacity: activeOpacity.default },
};
